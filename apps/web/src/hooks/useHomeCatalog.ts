...
import type { ProductsResponse, CategoriesResponse } from "../types/homeCatalog.ts";
...
export function useHomeCatalog() {
  ...
  const { data: productsData, isLoading: loadingList, error,} = useQuery<ProductsResponse>({
