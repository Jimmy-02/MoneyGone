      ...
      <div className="navbar mx-auto min-h-14 max-w-7xl px-4 py-2.5 md:px-6 md:py-3">
        <div className="flex-1">
          ...
          >
            ...
            <span className="leading-none">MoneyGone</span>
          </Link>
        </div>
        <nav className="flex items-center gap-1 md:gap-1.5">
          ...
          >
            {cartCount > 0 ? (
              <span className="indicator-item badge badge-sm badge-primary min-w-2 px-1.5 m-1.5 font-sans text-xs tabular-nums">
